...
const WhiteCity = () => {
    ...
    return (
        ...
        <h1 className="city-title">Trash Removal White City</h1>
        <h2 className="city-desc">Wasatch Junk Pros proudly serves White City as your reliable, professional, and eco-friendly solution for junk removal needs.</h2>
        ...
        <h2 className="city-desc">How Our White City Junk Removal Works:</h2>
        ...
        <p className="cta-description">
          Ready to reclaim your space? Click <Link to={`/book-now`} className="cta-link">HERE</Link> to schedule your eco-friendly junk removal services in White City!
        </p>
      </div>
    )
}
