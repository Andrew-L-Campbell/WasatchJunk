...
const CedarHills = () => {
    ...
    return (
        ...
        <h1 className="city-title">Trash Removal Cedar Hills</h1>
        <h2 className="city-desc">Wasatch Junk Pros proudly serves Cedar Hills as your reliable, professional, and eco-friendly solution for junk removal needs.</h2>
        ...
        <h2 className="city-desc">How Our Cedar Hills Junk Removal Works:</h2>
        ...
        <p className="cta-description">
          Ready to reclaim your space? Click <Link to={`/book-now`} className="cta-link">HERE</Link> to schedule your eco-friendly junk removal services in Cedar Hills!
        </p>
      </div>
    )
}
export default CedarHills;