...
const CottonwoodHeights = () => {

    return (
        <div className="city-container">
        <h1 className="city-title">Trash Removal Cottonwood Heights</h1>
        <h2 className="city-desc">Wasatch Junk Pros proudly serves Cottonwood Heights as your reliable, professional, and eco-friendly solution for junk removal needs.</h2>
        ...
        <h2 className="city-desc">How Our Cottonwood Heights Junk Removal Works:</h2>
        ...
        <p className="cta-description">
          Ready to reclaim your space? Click <Link to={`/book-now`} className="cta-link">HERE</Link> to schedule your eco-friendly junk removal services in Cottonwood Heights!
        </p>
      </div>
    )
}
export default CottonwoodHeights;