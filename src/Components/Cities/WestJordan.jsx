...
const WestJordan = () => {
    ...
    return (
        ...
        <h1 className="city-title">Trash Removal West Jordan</h1>
        <h2 className="city-desc">Wasatch Junk Pros proudly serves West Jordan as your reliable, professional, and eco-friendly solution for junk removal needs.</h2>
        ...
        <h2 className="city-desc">How Our West Jordan Junk Removal Works:</h2>
        ...
        <p className="cta-description">
          Ready to reclaim your space? Click <Link to={`/book-now`} className="cta-link">HERE</Link> to schedule your eco-friendly junk removal services in West Jordan!
        </p>
      </div>
    )
}
export default WestJordan;